...
function ReadUnitData( unit:table )
  ...
  kSubjectData.PrefixOnlyIconNam = iconNamePrefixOnly;
...
-- ===========================================================================
function OnUnitActionClicked_MoveTo(nused1, unused2, currentMode:number)
...
function OnInputActionTriggered( actionId )
  if (not g_isOkayToProcessor ContextPtr:IsHidden()) then
    return;
  end
